...
export const NAV: NavSection[] = [
  ...
  },
  {
    title: "Masters",
    items: [
      { label: "Companies", to: "/companies", icon: Building2, permission: "company", status: "planned", legacy: "/Company/CreateCompany" },
      { label: "Sites", to: "/sites", icon: MapPin, permission: "site", status: "planned", legacy: "/SiteMaster/SiteListView" },
      { label: "Site Groups", to: "/site-groups", icon: Layers, permission: "site", status: "planned", legacy: "/SiteMaster/CreateGroup" },
